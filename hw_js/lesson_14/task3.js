...
if (confirm(`Start testing`)) {
  ...
  let discountItemsCount = dataList.reduce((count, item) => {
    return item.price < item.old_price ? count + 1 : count
  }, 0)
  console.log(`Number of items with discount: ${discountItemsCount}`)
  console.log(`........................................`)

  // ===================================================================

  let availableItems = dataList.filter(item => item.sell_status === `available`)
  console.log(`Available items:`, availableItems)
  console.log(`........................................`)

  // ===================================================================

  let newList = dataList.filter(item => item.sell_status === `available`)
    .map(item => ({
      id: item.id,
      price: item.price,
